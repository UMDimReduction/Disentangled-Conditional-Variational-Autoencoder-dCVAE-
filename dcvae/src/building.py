...
def build_ae(model_type, input_shape, anomaly, latent_dim=20, condition_dim=10):
    """
    ...
    Args:
        ...
        latent_dim: Dimensionality of the latent space (adjusted to improve accuracy).
        condition_dim: Conditional dimension for models that use conditioning.
    Returns:
        ae: The built autoencoder model.
    """
    # Adjust latent dimensions dynamically for more complex models if needed
